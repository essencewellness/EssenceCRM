    ...
    <div>
      ...
      <div style={{ marginBottom: "24px" }}>
        {!mostraCriar ? (
          ...
          <div style={{
            padding: "20px", backgroundColor: "#fff", border: "1px solid #ddd6c4",
            borderRadius: "6px", maxWidth: "400px",
          }}>
            <p style={{ fontSize: "11px", fontWeight: 700, letterSpacing: "0.16em", textTransform: "uppercase", color: "#9d9d9a", fontFamily: "var(--font-sans, sans-serif)", marginBottom: "14px" }}>
              Nova Etiqueta
            </p>
            ...
            <input
              ...
              style={{ width: "100%", padding: "8px 12px", borderRadius: "4px", border: "1px solid #ddd6c4", fontSize: "13px", fontFamily: "var(--font-sans, sans-serif)", color: "#161a26", outline: "none", boxSizing: "border-box", marginBottom: "12px" }}
            />
            ...
            <div style={{ display: "flex", gap: "6px", marginBottom: "12px" }}>
              {(["saude", "campanha", "preferencia"] as const).map(t => (
                <button key={t} onClick={() => setNovoTipo(t)} style={{
                  ...
                  border: `1px solid ${novoTipo === t ? "rgba(185,160,122,0.5)" : "#ddd6c4"}`,
            ...
            {novoTipo === "saude" && (
              <label style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "12px", cursor: "pointer" }}>
                ...
                <span style={{ fontSize: "12px", fontFamily: "var(--font-sans, sans-serif)", color: "#6d6d6d" }}>Bloquear automações</span>
              </label>
            )}
            ...
            <div style={{ display: "flex", gap: "8px" }}>
              <button onClick={() => { setMostraCriar(false); setErroNovo("") }} style={{ flex: 1, padding: "8px", borderRadius: "4px", fontSize: "12px", fontFamily: "var(--font-sans, sans-serif)", border: "1px solid #ddd6c4", color: "#9d9d9a", backgroundColor: "transparent", cursor: "pointer" }}>
                Cancelar
              </button>
        ...
        return (
          <div key={tipo} style={{ marginBottom: "28px" }}>
            <p style={{
              ...
              color: "#9d9d9a", fontFamily: "var(--font-sans, sans-serif)", marginBottom: "10px",
              borderBottom: "1px solid #f0ebe0", paddingBottom: "8px",
            }}>
              ...
              {tags.map(tag => {
                ...
                return (
                  <div key={tag.id} style={{
                    ...
                    border: "1px solid #e8e2d8", borderRadius: "4px",
                  }}>
                    {isEditing ? (
                      <>
                        ...
                        <input
                          ...
                          style={{ flex: 1, padding: "4px 8px", borderRadius: "4px", border: "1px solid #ddd6c4", fontSize: "13px", fontFamily: "var(--font-sans, sans-serif)", color: "#161a26", outline: "none" }}
                          onKeyDown={e => { if (e.key === "Enter") handleAtualizar(tag.id); if (e.key === "Escape") cancelarEdicao() }}
                          autoFocus
                        />
                        {tag.tipo === "saude" && (
                          <label style={{ display: "flex", alignItems: "center", gap: "5px", fontSize: "11px", color: "#6d6d6d", fontFamily: "var(--font-sans, sans-serif)", cursor: "pointer", flexShrink: 0 }}>
                        ...
                        <div style={{ display: "flex", flexWrap: "wrap", gap: "4px" }}>
                          {CORES_PALETA.map(cor => (
                            <button key={cor} onClick={() => setEditCor(cor)} style={{ width: "16px", height: "16px", borderRadius: "50%", backgroundColor: cor, border: editCor === cor ? "2px solid #161a26" : "2px solid transparent", cursor: "pointer", padding: 0 }} />
                          ))}
                        </div>
                        ...
                        <button onClick={cancelarEdicao} style={{ background: "none", border: "none", cursor: "pointer", color: "#9d9d9a", padding: "2px" }}><X size={14} /></button>
                      </>
                    ) : (
                      <>
                        ...
                        {!isAutomatica && (
                          <>
                            <button onClick={() => iniciarEdicao(tag)} style={{ background: "none", border: "none", cursor: "pointer", color: "#9d9d9a", padding: "4px" }}
