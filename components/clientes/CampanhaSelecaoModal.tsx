        ...
        {resultado ? (
          ...
          <>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "18px" }}>
              <h3 style={{ fontFamily: "var(--font-heading, Georgia, serif)", fontSize: "calc(20px * var(--ui-font-scale))", color: "var(--nuit-bone)" }}>
            ...
            <div style={{ marginBottom: "14px" }}>
              ...
              <input
                ...
                style={{ width: "100%", padding: "9px 12px", borderRadius: "4px", border: "1px solid rgba(212,184,134,0.22)", fontSize: "calc(15px * var(--ui-font-scale))", fontFamily: "var(--font-sans, sans-serif)", color: "var(--nuit-bone)", backgroundColor: "var(--nuit-midnight)", outline: "none", boxSizing: "border-box" }}
              />
            </div>
                ...
                {(["whatsapp", "email"] as const).map(opcao => (
                  <button
                    ...
                    style={{
                      ...
                      fontSize: "calc(12px * var(--ui-font-scale))", fontWeight: 600, fontFamily: "var(--font-sans, sans-serif)", textTransform: "capitalize",
            ...
            <div style={{ marginBottom: "10px" }}>
              ...
              {modoMensagem === "template" ? (
                <select
                  ...
                  style={{ width: "100%", padding: "9px 12px", borderRadius: "4px", border: "1px solid rgba(212,184,134,0.22)", fontSize: "calc(15px * var(--ui-font-scale))", fontFamily: "var(--font-sans, sans-serif)", color: "var(--nuit-bone)", outline: "none", backgroundColor: "var(--nuit-midnight)" }}
                >
            ...
            <p style={{ fontSize: "calc(12px * var(--ui-font-scale))", color: "var(--nuit-bone-soft)", fontFamily: "var(--font-sans, sans-serif)", margin: "8px 0 16px" }}>
              As mensagens ficam <strong>pendentes</strong> em /mensagens até seres tu a aprová-las — nada sai sozinho.
            </p>

            {erro && (
              <p style={{ fontSize: "calc(12.5px * var(--ui-font-scale))", color: "var(--destructive)", fontFamily: "var(--font-sans, sans-serif)", marginBottom: "12px" }}>{erro}</p>
            )}
            ...
            <div style={{ display: "flex", gap: "10px" }}>
              ...
              <button
                ...
                style={{ flex: 1, padding: "9px", borderRadius: "4px", fontSize: "calc(13px * var(--ui-font-scale))", fontFamily: "var(--font-sans, sans-serif)", fontWeight: 600, border: "none", color: "#fff", backgroundColor: "var(--nuit-champagne-soft)", cursor: nome.trim() && mensagemValida ? "pointer" : "not-allowed", opacity: nome.trim() && mensagemValida ? 1 : 0.5 }}
              >
